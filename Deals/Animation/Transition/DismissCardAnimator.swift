...
final class DismissCardAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    struct Params {
        ...
        let fromCell: DealsListingTableViewCell
    }
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let screens: (cardDetail: DealDetailsViewController, home: HomeViewController) = (
            ctx.viewController(forKey: .from)! as! DealDetailsViewController,
        ...
        // Fix weird top inset
        let topTemporaryFix = screens.cardDetail.dealImageView.topAnchor.constraint(equalTo: cardDetailView.topAnchor)
        topTemporaryFix.isActive = GlobalConstants.isEnabledWeirdTopInsetsFix

        container.layoutIfNeeded()

        // Force card filling bottom
        let stretchCardToFillBottom = screens.cardDetail.dealImageView.bottomAnchor.constraint(equalTo: cardDetailView.bottomAnchor)
