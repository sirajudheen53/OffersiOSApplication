...
let categoriesImagesList = ["restaurent", "carcare", "services", "beauty", "entertainment", "health", "retail", "travel"]
let categoriesTitleList = ["Restaurent", "Car Care", "Services", "Beauty",  "Entertainment", "Health", "Retail", "Travel"]
